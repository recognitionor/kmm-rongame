                ...
                this.add(
                    Card(-1,
                        ...
                        type = hashSetOf<CardType>().apply {
                            this.add(CardTypeConst.TYPE_LIST[CardTypeConst.FIRE])
                        })
                )
                this.add(
                    Card(-1,
                        ...
                        type = hashSetOf<CardType>().apply {
                            this.add(CardTypeConst.TYPE_LIST[CardTypeConst.WATER])
                        })
                )
                this.add(
                    Card(-1,
                        ...
                        type = hashSetOf<CardType>().apply {
                            this.add(CardTypeConst.TYPE_LIST[CardTypeConst.GROUND])
                        })
                )
                this.add(
                    Card(-1,
                        ...
                        type = hashSetOf<CardType>().apply {
                            this.add(CardTypeConst.TYPE_LIST[CardTypeConst.GOOD])
                        })
                )
                this.add(
                    Card(-1,
                        ...
                        type = hashSetOf<CardType>().apply {
                            this.add(CardTypeConst.TYPE_LIST[CardTypeConst.BAD])
                        })
                )
                this.add(
                    Card(-1,
                        ...
                        type = hashSetOf<CardType>().apply {
                            this.add(CardTypeConst.TYPE_LIST[CardTypeConst.WEIRD])
                        })
                )
            }
        }
